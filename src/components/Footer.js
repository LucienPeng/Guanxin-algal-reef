  ...
  return (
    <footer>
      <div className=' bg-sky-800 pt-4 pb-8 dark:bg-gray-800 xl:pt-8'>
        <div className='mx-auto mt-5 max-w-screen-lg text-gray-400 dark:text-gray-300 sm:px-6 md:px-8 xl:max-w-screen-xl'>
          <ul className='flex flex-nowrap justify-center pb-8 text-lg font-light'>
            <li className='w-1/2 md:w-1/3 lg:w-1/3'>
              <div className='text-center'>
                <h2 className='mb-5 text-xl text-white dark:text-gray-200'>
                  認識我們
                </h2>
                  ...
                  <li className='flex justify-center'>
                    <Stack spacing={2}>
                      <Box sx={{ display: 'flex' }}>
                        ...
                        <li className='ml-5 text-gray-300 hover:scale-110 hover:text-amber-300'>
      ...
      <div className='bg-sky-900 py-3 text-center text-sm text-gray-300'>
